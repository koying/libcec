...
namespace CEC
{
  ...
  class CTegraCECAdapterCommunication : public IAdapterCommunication, public PLATFORM::CThread
  {
  public:
    /*!
     ...
     */
    CTegraCECAdapterCommunication(IAdapterCommunicationCallback *callback);
    virtual ~CTegraCECAdapterCommunication(void);
    ...
    std::string GetPortName(void) { return std::string("Tegra"); }
