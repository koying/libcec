...
namespace CEC
{
  ...
  class CGenericSerialAdapterCommunication : public IAdapterCommunication, public PLATFORM::CThread
  {
  public:
    /*!
     ...
     */
    CGenericSerialAdapterCommunication(IAdapterCommunicationCallback *callback);
    virtual ~CGenericSerialAdapterCommunication(void);
