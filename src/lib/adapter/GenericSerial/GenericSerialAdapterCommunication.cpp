...
#include "GenericSerialAdapterCommunication.h"
...
CGenericSerialAdapterCommunication::CGenericSerialAdapterCommunication(IAdapterCommunicationCallback *callback) :
...
CGenericSerialAdapterCommunication::~CGenericSerialAdapterCommunication(void)
{
  Close();
...
bool CGenericSerialAdapterCommunication::IsOpen(void)
{
  return IsInitialised() && m_dev->IsOpen();
}

    
bool CGenericSerialAdapterCommunication::Open(uint32_t iTimeoutMs, bool UNUSED(bSkipChecks), bool bStartListening)
{
...
void CGenericSerialAdapterCommunication::Close(void)
{
  StopThread(0);
...
std::string CGenericSerialAdapterCommunication::GetError(void) const
{
...
cec_adapter_message_state CGenericSerialAdapterCommunication::Write(
...
uint16_t CGenericSerialAdapterCommunication::GetFirmwareVersion(void)
{
...
cec_vendor_id CGenericSerialAdapterCommunication::GetVendorId(void)
{
  cec_raw_info info;
...
uint16_t CGenericSerialAdapterCommunication::GetPhysicalAddress(void)
{
  cec_raw_info info;
...
cec_logical_addresses CGenericSerialAdapterCommunication::GetLogicalAddresses(void)
{
  CLockObject lock(m_mutex);
...
bool CGenericSerialAdapterCommunication::SetLogicalAddresses(const cec_logical_addresses &addresses)
{
...
void CGenericSerialAdapterCommunication::HandleLogicalAddressLost(cec_logical_address UNUSED(oldAddress))
{
...
void *CGenericSerialAdapterCommunication::Process(void)
{
  bool bHandled;
  cec_frame frame;
